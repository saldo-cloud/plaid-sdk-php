...
[![Build Status](https://img.shields.io/travis/SaldoCloud/plaid-sdk-php.svg?style=flat-square)](https://travis-ci.com/SaldoCloud/plaid-sdk-php)
[![Code Coverage](https://img.shields.io/coveralls/github/SaldoCloud/plaid-sdk-php.svg?style=flat-square)](https://coveralls.io/github/SaldoCloud/plaid-sdk-php)
[![License](https://img.shields.io/github/license/SaldoCloud/plaid-sdk-php.svg?style=flat-square)](https://packagist.org/packages/tomorrow-ideas/plaid-sdk-php)
...
```bash
composer require saldo-cloud/plaid-sdk-php
```
...
```php
$client = new \SaldoCloud\Plaid\Plaid("your-client-id", "your-secret", "environment");
```
...
The `SaldoCloud\Plaid\Entities\User` entity is used to represent your end user when creating a new link token.
...
The `SaldoCloud\Plaid\Entities\RecipientAddress` entity is used to represent an address object for the recipient of a payment request.

Example:

```php
$address = new SaldoCloud\Plaid\Entities\RecipientAddress("123 Elm St.", "Apt 1", "Anytown", "ABC 123", "GB");
```
...
The `SaldoCloud\Plaid\Entities\PaymnentSchedule` entity is used when creating a new payment that will be a recurring charge.
See `createPayment` method for more information.

```php
$payment_schedule = new SaldoCloud\Plaid\Entities\PaymnentSchedule(
